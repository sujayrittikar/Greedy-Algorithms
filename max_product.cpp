/*
	...
	2] If there are odd number of negative numbers and no zeros, result is product of all except the negative integer with least absolute value.
	3] If there are zeros, result is product of all except these zeros with one exceptional case:
	When there is one negative no and all other elements are 0, result=0
*/
